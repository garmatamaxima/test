...
void iostream()
{
    ...
    // ---- COUT, CHARACTER OUT: ----
    /*
    "std::cout" is a statement (îïåðàòîð), std:: means we take a function from standart library, cout is the part of iostream library
     inside standart library
    "<<" INSERTION OPERATOR: allows to display information on console and concatenate (connect strings together, îáºäíóâàòè ðÿäêè ó îäèí)
